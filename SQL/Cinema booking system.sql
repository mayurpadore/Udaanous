...
ALTER TABLE Screenings DROP COLUMN EndTime ;
...
ALTER TABLE Films ADD Length_min INT ;
...
INSERT INTO Screenings (FilmID, Room_NO, StartTime)
...
INSERT INTO Films (Movie, Genre, Length_min)
VALUES ('Blade Runner 2049', 'Sci-Fi', 153),
('Dunkirk','War', 106),
('Geostorm','Disaster', 121),
('Thor: Ragnarok','Super-Heros', 107),
('Jigsaw','Horror', 116),
('The Death of Stalin','History', 98),
('The Lego Ninjago Movie','Animated', 101),
('Murder on the Orient Express','Mystery', 135),
('Paddington 2','Adventure', 88),
('Breathe','Drama', 117),
('Blade Runner','Sci-Fi',127),
('Victoria and Abdul','Drama', 112);

INSERT INTO Seats (Seat_Row, SeatNumber, Room_NO)
...
INSERT INTO Bookings (ScreenID, CustomerID)
...
-- We've created 7 tables - Screenings, Rooms, Films, Seats, ReservedSeat, Bookings, Customers.
...
ADD CONSTRAINT FOREIGN KEY (FilmID) REFERENCES Films(FilmID),
ADD CONSTRAINT FOREIGN KEY (Room_NO) REFERENCES Rooms(Room_NO) ;

ALTER TABLE Bookings
ADD CONSTRAINT FOREIGN KEY (ScreenID) REFERENCES Screenings(ScreenID),
ADD CONSTRAINT FOREIGN KEY (CustomerID) REFERENCES Customers(CustomerID) ;

ALTER TABLE ReservedSeat
ADD CONSTRAINT FOREIGN KEY (SeatID) REFERENCES Seats(SeatID) ;

ALTER TABLE ReservedSeat
ADD CONSTRAINT FOREIGN KEY (BookingID) REFERENCES Bookings(BookingID) ;
